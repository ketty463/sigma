...
if not getgenv().Captive or getgenv().Captive.WallHack then return end
...
local Environment = getgenv().Captive.WallHack
...
function Environment.Functions:Exit()
	...
	getgenv().Captive.WallHack.Functions = nil
	getgenv().Captive.WallHack = nil
